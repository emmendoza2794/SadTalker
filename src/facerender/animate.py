...
from src.utils.face_enhancer import enhancer_generator_with_len, enhancer_list, enhancer_generator_no_len
...
class AnimateFromCoeff():
    ...
    def generate(
        ...
        if enhancer:
            ...
            av_path_enhancer_frames = os.path.join(video_save_dir, 'frames')
            return_path = av_path_enhancer

            os.makedirs(av_path_enhancer_frames, exist_ok=True)

            try:
                enhanced_images_gen_with_len = enhancer_generator_no_len(
                    full_video_path,
                    method=enhancer,
                    bg_upsampler=background_enhancer,
                    save_dir=av_path_enhancer_frames,
                )

                if not enhanced_images_gen_with_len:
                ...
                print('error in enhancer_generator_with_len', e)
